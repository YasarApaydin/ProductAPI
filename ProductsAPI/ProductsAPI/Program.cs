...
var MyAllowSpesificAnyOrigins = "_myAllowSpesificAnyOrigins";
...
{
    options.AddPolicy(MyAllowSpesificAnyOrigins, policy =>
    {
...
app.UseCors(MyAllowSpesificAnyOrigins);
